...
web3.eth.getTransactionCount(account1, (err, txCount) => {
  // tx object for value transaction from one account to another.
  const txObject = {
  ...
  // tx object to deploy smart contract to ether test network.
  /* const txObject = {
    nonce: web3.utils.toHex(txCount),
    gasLimit: web3.utils.toHex(21000),
    gasPrice: web3.utils.toHex(web3.utils.toWei("10", "gwei")),
    data: '' // smart contract data (in hexadecimal) can be taken from remix.ethereum.org
  }; */
